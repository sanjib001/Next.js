        ...
        <section id="services" className="mb-10 pt-5 text-center" >
            ...
            <div className="flex flex-wrap gap-6">
                {services.map((service, index) => (
                    <div
                        key={index}
                        className="w-full sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] bg-gray-100 p-5 rounded-2xl flex flex-col gap-2 text-left border border-gray-300 transition-transform duration-500 hover:-translate-y-1"
                    >
                        {/* ICON */}
                        <div className="h-12 w-12 flex items-center justify-center bg-white rounded-lg border border-gray-300 transition-transform duration-500 hover:scale-110">
                            <svg
                        ...
                        <p className="text-sm leading-relaxed text-brand-gray break-words">
                            {service.description}
                        </p>
                    </div>
                ))}
